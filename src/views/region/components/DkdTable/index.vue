  ...
  >
    ...
    <el-table-column label="操作" width="200">
      <template slot-scope="scope">
        ...
        <!-- 弹出框 -->
        <el-dialog title="修改区域" width="35%" :visible.sync="dialogFormVisible">
          <div class="change">
            <el-form :model="changeList">
              <el-form-item label="区域名称">
                <el-input v-model="changeList.name" type="textarea" show-word-limit maxlength="15" />
              </el-form-item>
              <el-form-item label="城北街道">
                <el-input v-model="changeList.remark" type="textarea" show-word-limit maxlength="40" rows="2" />
              </el-form-item>
            </el-form>
